          ...
          return (
            <Link
              ...
              style={{
                ...
                borderRadius: "8px",
                textDecoration: "none",
                borderTop: isActive ? "1px solid #F1D46A" : "1px solid transparent",
                borderRight: isActive ? "1px solid #F1D46A" : "1px solid transparent",
                borderBottom: isActive ? "1px solid #F1D46A" : "1px solid transparent",
