...
def test_negotiation_flow_atomic_create_counter_accept():
    # criar usuários com emails únicos para evitar conflitos
    ...
    # perfis (são criados automaticamente por signals.post_save no model User)
