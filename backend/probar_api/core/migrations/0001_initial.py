# Generated by Django 5.2.6 on 2026-04-13 13:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(choices=[('cliente', 'Cliente'), ('bartender', 'Bartender')], default='cliente', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(choices=[('cliente', 'Termos para Clientes'), ('bartender', 'Termos para Bartenders')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('foto', models.ImageField(blank=True, null=True, upload_to=core.models.drink_image_path)),
                ('bartender', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='drinks', to='core.bartender')),
            ],
            options={
                'verbose_name': 'Drink',
